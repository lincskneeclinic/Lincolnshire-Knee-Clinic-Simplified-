    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-white py-20 md:py-28 w-full border-b border-border-clinical">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="max-w-2xl mx-auto bg-soft-blue border border-border-clinical/30 rounded-xl p-6 md:p-8 text-center shadow-[0_4px_20px_rgba(8,47,73,0.02)] animate-fadeIn">
            <div className="flex items-center justify-center gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border border-border-clinical text-[#4285F4] font-bold shrink-0 shadow-sm animate-fadeIn" title="Google Reviews">
                G
              </div>
              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center border border-border-clinical text-[#00AFC8] font-bold shrink-0 shadow-sm animate-fadeIn" title="iWantGreatCare Reviews">
                i
              </div>
            </div>
            <p className="text-text-secondary text-sm leading-relaxed mb-6">
              We are in the process of collecting independent, verified patient reviews via Google and iWantGreatCare.
