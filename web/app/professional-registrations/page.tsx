...
export const metadata: Metadata = {
  title: "Professional Registrations | Lincolnshire Knee Clinic",
  description:
    "Draft content awaiting clinical and legal review — professional registrations and credentials for Lincolnshire Knee Clinic consultants.",
  robots: {
    index: false,
    follow: false,
  },
